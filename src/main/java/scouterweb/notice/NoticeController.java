...
//        }
        model.addAttribute("testAttr", "test-value23");
        res.setHeader("X-Scouter-ETag", DigestUtils.md5DigestAsHex("-scouter-20201219-01".getBytes()));
        return "latestNotice";
    }
    ...
    public NoticeResponse getPaperLatestNotice(HttpServletRequest req, HttpServletResponse res) {
        ...
        String noticeToken = DigestUtils.md5DigestAsHex("scouter-paper-202012-19".getBytes());
